...
export default async function ZiyaratGuideLangPage({ params }: Params) {
  ...
  return (
    <div className="guide" dir={meta.dir} lang={lang}>
      ...
      <main>
        {/* 1 + 2 — dark hero band: breadcrumb, pill, title, intro, switcher */}
        <section className="guide-hero">
          <div className="guide-container">
            <nav aria-label="Breadcrumb" className="guide-breadcrumb">
              <a href="/">{s(t.nav as Record<string, unknown>, 'home', 'Home')}</a>
              <span aria-hidden>/</span>
              {s(g, 'navLabel', 'Ziyarat Guide')}
            </nav>
        ...
        <section className="guide-section--tight">
          <div className="guide-container">
            <div className="guide-grid" style={{ alignItems: 'center' }}>
              <a className="guide-hero__media" href="/ziyarat-guide/print" aria-hidden tabIndex={-1}>
                <img
              ...
              <div className="guide-prose">
                ...
                <a className="guide-btn" href="/ziyarat-guide/print">
